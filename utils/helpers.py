...
async def force_sub(bot, message):
    ...
    try:
       ...
       await message.reply(f"<b>🚀 Mrs {message.from_user.mention}\n\n If U Want Movie Join Below My Updates Channel After Ask In this group U get Direct link Ads Free</b>", 
